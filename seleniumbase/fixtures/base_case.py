...
class Base:
    ...
    def get_current_url(self):
        ...
        if "%" in current_url and sys.version_info[0] >= 3:
            try:
                ...
                current_url = urllib.parse.unquote(current_url, errors="strict")
            except Exception:
                pass
        return current_url
    ...
    def __recalculate_selector(self, selector=None, by=None, xp_ok=True):
    ...
    @staticmethod
    def __are_quotes_escaped(string):
        """
        __are_quotes_escaped
        """
    ...
    @staticmethod
    def get_link_status_code(link, allow_redirects=False, timeout=5):
    ...
    def assert_link_status_code_is_not_404(self, link):
        ...
        self.unittest.assertNotEqual(status_code, "404", bad_link_str)
    ...
    @staticmethod
    def __fix_unicode_conversion(text):
    ...
    def assert_equal(self, first, second, msg=None):
        ...
        self.unittest.assertEqual(first, second, msg=msg)

    def assert_not_equal(self, first, second, msg=None):
        """Asserts that the two values are not equal.
        Will raise an exception if the values are equal."""
        self.unittest.assertNotEqual(first, second, msg=msg)
    ...
    def assert_raises(self, *args, **kwargs):
        ...
        """
        self.unittest.assertRaises(*args, **kwargs)
    ...
    def assert_title(self, title):
        ...
        try:
            self.unittest.assertEqual(expected, actual, error % (expected, actual))
        except Exception:
            self.wait_for_ready_state_complete()
    ...
    def get_element(self, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        return self.wait_for_element_present(timeout=timeout)


    def wait_for_element_present(self, timeout=None):
...
class BaseCase:
    ...
    def __init__(self, selector, by=By.CSS_SELECTOR, description=None):
    ...
    # def get_element(self, sec=10) -> WebElement:
    #     """
    #     获取一个元素
    #     :param sec:等待秒数
    ...
    #     """
    #     try:
    #         elements = WebDriverWait(driver, 60, 1).until(lambda x: x.find_elements(**self.by, *self.selector))
    #         return elements
    #     except Exception as e:
    #         raise e

    def wait_for_element_visible(self, selector=None, by=None, timeout=None):
    ...
    def click(self, timeout=None, delay=0.0):
        """
        点击
        """
        if not timeout:
        ...
        element = page_actions.wait_for_element_visible(self.driver, self.selector, self.by, timeout=timeout)
    ...
    def slow_click(self, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
            self.click(timeout=timeout, delay=1.05)

        else:
            # Demo Mode already includes a small delay
            self.click(timeout=timeout, delay=0.25)
    ...
    def update_text(self, text, timeout=None, retry=False):
        ...
        * Hits Enter/Submit (if the text ends in "\n").
        ...
        element = self.wait_for_element_visible(timeout=timeout)
    ...
    def add_text(self, text, timeout=None):
    ...
    def type(self, text, timeout=None, retry=False):
        ...
        * Hits Enter/Submit (if the text ends in "\n").
        ...
        if self.timeout_multiplier and timeout == settings.LARGE_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        self.update_text(text, timeout=timeout, retry=retry)

    def submit(self):
        """ Alternative to self.driver.find_element_by_*(SELECTOR).submit() """
        self.__check_scope()
        element = self.wait_for_element_visible(timeout=settings.SMALL_TIMEOUT)
        element.submit()
    ...
    def clear(self, timeout=None):
        ...
        element = self.wait_for_element_visible(timeout=timeout)
        self.scroll_to(timeout=timeout)
        try:
            element.clear()
    ...
    def is_element_present(self, **kwargs):
        """
        is_element_present
        """
        self.wait_for_ready_state_complete()
    ...
    def is_element_visible(self, selector=None, by=By.CSS_SELECTOR):
        """
        is_element_visible
        """
        self.wait_for_ready_state_complete()
    ...
    def is_text_visible(self, text):
        ...
        time.sleep(0.01)
        selector, by = self.__recalculate_selector()
        return page_actions.is_text_visible(driver, text, selector, by)
    ...
    def get_attribute(self, attribute, timeout=None, hard_fail=True):
    ...
    def set_attribute(self, attribute, value, timeout=None):
    ...
    def set_attribute_all(self, attribute, value):
        """Same as set_attributes(), but using querySelectorAll naming scheme.
        This method uses JavaScript to set/update a common attribute.
        All matching selectors from querySelectorAll() are used.
        Example => (Make all links on a website redirect to Google):
        self.set_attribute_all("a", "href", "https://google.com")"""
        self.set_attributes(attribute, value)

    def remove_attribute(self, attribute, timeout=None):
    ...
    def get_property_value(self, property, timeout=None):
    ...
    def get_image_url(self, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        return self.get_attribute(attribute="src", timeout=timeout)

    def find_elements(self, limit=0):
    ...
    def find_visible_elements(self, limit=0):
    ...
    def click_visible_elements(self, limit=0, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        selector, by = self.__recalculate_selector()
        self.wait_for_element_present(timeout=timeout)
    ...
    def click_nth_visible_element(self, number, timeout=None):
    ...
    def is_checked(self, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        selector, by = self.__recalculate_selector()
        kind = self.get_attribute("type", timeout=timeout)
        if kind != "checkbox" and kind != "radio":
            raise Exception("Expecting a checkbox or a radio button element!")
        is_checked = self.get_attribute("checked", timeout=timeout, hard_fail=False
        )
        if is_checked:
            return True
        else:  # (NoneType)
    ...
    def is_selected(self, timeout=None):
        """ Same as is_checked() """
        return self.is_checked(timeout=timeout)

    def check_if_unchecked(self):
    ...
    def select_if_unselected(self):
        """ Same as check_if_unchecked() """
        self.check_if_unchecked()

    def uncheck_if_checked(self):
    ...
    def unselect_if_selected(self):
        """ Same as uncheck_if_checked() """
        self.uncheck_if_checked()

    def is_element_in_an_iframe(self):
    ...
    def switch_to_frame_of_element(self):
    ...
    def hover_on_element(self):
        ...
        original_selector = self.selector
        original_by = self.by
        selector, by = self.__recalculate_selector(self.selector, self.by)
        if page_utils.is_xpath_selector(selector):
            selector = self.convert_to_css_selector(selector, By.XPATH)
            by = By.CSS_SELECTOR
        self.wait_for_element_visible(timeout=settings.SMALL_TIMEOUT)
        self.scroll_to()
    ...
    def drag_and_drop(self, drop_selector, drop_by=By.CSS_SELECTOR, timeout=None):
        """ Drag and drop an element from one selector to another. """
        drag_selector = self.selector
        drag_by = self.by
        self.__check_scope()
        if not timeout:
            timeout = settings.SMALL_TIMEOUT
        ...
        drop_selector, drop_by = self.__recalculate_selector(drop_selector, drop_by
        )
        drag_element = self.wait_for_element_visible(timeout=timeout)
    ...
    def drag_and_drop_with_offset(self, x, y, timeout=None):
    ...
    def select_option(self, option, option_by="text", timeout=None):
        ...
        self.wait_for_ready_state_complete()
        element = self.wait_for_element_present(timeout=timeout)
    ...
    def select_option_by_text(self, option, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        self.select_option(option, timeout=timeout)

    def select_option_by_index(self, option, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        self.select_option(option, option_by="index", timeout=timeout)

    def select_option_by_value(self, option, timeout=None):
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        self.select_option(option, option_by="value", timeout=timeout)
    ...
    def highlight_update_text(self, text, loops=3, scroll=True):
        """
        highlight_update_text
        """
        self.__check_scope()
            # self.highlight(loops=loops, scroll=scroll)
    ...
    def scroll_to(self, selector=None, by=By.CSS_SELECTOR, timeout=None):
    ...
    def js_click(self, selector=None, by=None, all_matches=False):
        ...
        if by == By.LINK_TEXT:
            ...
            self.click()
            return
        element = self.wait_for_element_present(timeout=settings.SMALL_TIMEOUT)
        if self.is_element_visible(selector, by=by):
    ...
    def jquery_click(self, selector, by=By.CSS_SELECTOR):
        ...
        self.__check_scope()
        selector, by = self.__recalculate_selector(selector, by, xp_ok=False)
        self.wait_for_element_present(timeout=settings.SMALL_TIMEOUT)
    ...
    def wait_for_attribute(self, attribute, value=None, timeout=None):
        ...
        return page_actions.wait_for_attribute(self.driver, selector, attribute, value=value, by=by, timeout=timeout)

    def assert_attribute(self, attribute, value=None, timeout=None):
        """Raises an exception if the element attribute/value is not found.
        If the value is not specified, the attribute only needs to exist.
        ...
        if self.timeout_multiplier and timeout == settings.SMALL_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        selector, by = self.__recalculate_selector()
        self.wait_for_attribute(attribute, value=value, timeout=timeout)
        if (
            self.is_element_visible(selector, by=by)
        ):
    ...
    def convert_to_css_selector(self,  selector=None, by=None):
        ...
        if selector is None or by is None:
            selector = self.selector
            by = self.by
    ...
    def set_value(self, selector=None, text=None, by=By.CSS_SELECTOR, timeout=None):
        """ This method uses JavaScript to update a text field. """
        self.__check_scope()
        (selector, by) = (self.selector, self.by) if selector is None else (selector, by)
        if not timeout:
            timeout = settings.LARGE_TIMEOUT
        if self.timeout_multiplier and timeout == settings.LARGE_TIMEOUT:
            timeout = self.__get_new_timeout(timeout)
        ...
        css_selector = self.convert_to_css_selector()
        self.scroll_to(timeout=timeout)
        if type(text) is int or type(text) is float:
            text = str(text)
    ...
    def js_update_text(self, selector=None, text=None, by=By.CSS_SELECTOR, timeout=None):
    ...
    def js_type(self, selector=None, text=None, by=By.CSS_SELECTOR, timeout=None):
    ...
    def set_text(self, selector=None, text=None, by=By.CSS_SELECTOR, timeout=None):
        """Same as self.js_update_text()
        JavaScript + send_keys are used to update a text field.
        Performs self.set_value() and triggers event listeners.
        If text ends in "\n", set_value() presses RETURN after.
    ...
    def jquery_update_text(self, selector=None, text=None, by=By.CSS_SELECTOR, timeout=None):
    ...
    def create_presentation(self, name=None, theme="default", transition="default"):
    ...
    def create_tour(self, name=None, theme=None):
        ...
        if theme:
            if theme.lower() == "bootstrap":
                ...
                self.create_intro_js_tour(name)
            elif theme.lower() == "introjs":
                self.create_intro_js_tour(name)
            elif theme.lower() == "driver":
                self.create_driver_js_tour(name)
    ...
    def create_driver_js_tour(self, name=None):
    ...
    def create_intro_js_tour(self, name=None):
    ...
    def add_tour_step(
        ...
        if "Bootstrap" in self._tour_steps[name][0]:
            ...
            self.__add_driver_js_tour_step(
                message,
                selector=selector,
                name=name,
                title=title,
    ...
    def wait_for_element(self, selector=None, by=By.CSS_SELECTOR, timeout=None):
        """Waits for an element to appear in the HTML of a page.
    ...
    def assert_element_present(self, timeout=None):
    ...
    def find_element(self, selector=None, by=By.CSS_SELECTOR, timeout=None):
    ...
    def assert_element(self, selector=None, by=By.CSS_SELECTOR, timeout=None):
    ...
    def assert_element_visible(
        self, selector=None, by=By.CSS_SELECTOR, timeout=None
    ):
    ...
    def assert_elements(self, *args, **kwargs):
        ...
        for arg in args:
            if type(arg) is list:
                ...
                selectors.append(arg)
        for selector in selectors:
            self.wait_for_element_visible(timeout=timeout)
    ...
    def deferred_assert_text(
        self, text=None, selector="html", by=By.CSS_SELECTOR, timeout=None
    ):
    ...
    @staticmethod
    def __make_css_match_first_element_only(selector):
        """
        __make_css_match_first_element_only
        """
    ...
    def wait_for_partial_link_text_present(self, link_text, timeout=None):
        """
        wait_for_partial_link_text_present
        """
        self.__check_scope()
        if not timeout:
            timeout = settings.SMALL_TIMEOUT
